...
func (oq *OutboxQuery) Order(o ...outbox.OrderOption) *OutboxQuery {
...
func (oq *OutboxQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (oq *OutboxQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (oq *OutboxQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (oq *OutboxQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (oq *OutboxQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (oq *OutboxQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := oq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (oq *OutboxQuery) Clone() *OutboxQuery {
	...
	return &OutboxQuery{
		config:     oq.config,
		ctx:        oq.ctx.Clone(),
		order:      append([]outbox.OrderOption{}, oq.order...),
...
func (oq *OutboxQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(outbox.Table, outbox.Columns, sqlgraph.NewFieldSpec(outbox.FieldID, field.TypeUUID))
	_spec.From = oq.sql
